<template>
  <a-layout style="min-height: 100vh">
    <a-layout-sider v-model:collapsed="collapsed" collapsible>
      <div class="flex justify-center h-[70px] items-center">
        ...
        <a-sub-menu key="sub1">
          <template #title>
            <span>
              ...
              <span class="ml-[5px]">项目列表</span>
            </span>
          </template>
          <a-menu-item key="2">全部项目</a-menu-item>
          <a-menu-item key="3">我的收藏</a-menu-item>
          <a-menu-item key="4">已归档项目</a-menu-item>
          <a-menu-item key="5">回收站</a-menu-item>
        </a-sub-menu>
        <a-menu-item key="1">
          <span>
            <book-outlined />
          ...
          <a-menu-item key="6"
            ><span class="flex items-center"
              ><Icon
                ...
                class="mr-[3px] text-[#909399] text-[19px]"
              />@我</span
            ></a-menu-item
          >
          <a-menu-item key="8"
    ...
    <a-layout>
      <a-layout-header
        style="box-shadow: 0 0 10px #ccc; background-color: #fff"
